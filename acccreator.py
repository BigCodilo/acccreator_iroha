...
def main():
    accounts_amount = input("Amount of accounts: ")
    start_time = time.time()
    acc_creator = AccCreator()
    acc_creator.Starting(int(accounts_amount))
    total_time = time.time() - start_time
    acc_creator.SaveAccsToCSV()
    print("Accounts created: ", accounts_amount)
    print("For: ", total_time, " seconds")
    print("Total transactions: ", acc_creator.txAmount)
